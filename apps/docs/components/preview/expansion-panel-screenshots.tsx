...
const screenshots = [
  { src: '/screenshots/expansion-panel-1.jpg', alt: 'Expansion Panel preview light mode' },
  { src: '/screenshots/expansion-panel-2.jpg', alt: 'Expansion Panel preview dark mode' },
] as const

export function ExpansionPanelScreenshots() {
  return (
