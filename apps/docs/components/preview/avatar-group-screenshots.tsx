...
const screenshots = [
  { src: '/screenshots/avatar-group-1.jpg', alt: 'AvatarGroup preview 1' },
  { src: '/screenshots/avatar-group-2.jpg', alt: 'AvatarGroup preview 2' },
] as const

export function AvatarGroupScreenshots() {
  return (
