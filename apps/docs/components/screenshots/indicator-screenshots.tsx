...
const screenshots = [
  { src: '/screenshots/indicator-1.jpg', alt: 'ActivityIndicator preview light mode' },
  { src: '/screenshots/indicator-2.jpg', alt: 'ActivityIndicator preview dark mode' },
] as const

export function IndicatorScreenshots() {
  return (
