...
const screenshots = [
  {
    src: '/screenshots/slider-1.jpg',
    alt: 'Slider preview dark mode - sizes, marks and vertical',
  },
  {
    src: '/screenshots/slider-2.jpg',
    alt: 'Slider preview light mode - controlled, steps and marks',
  },
] as const
