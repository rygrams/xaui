...
const screenshots = [
  { src: '/screenshots/pager-1.jpg', alt: 'Pager preview dark mode - onboarding slide 1' },
  { src: '/screenshots/pager-2.jpg', alt: 'Pager preview light mode - onboarding slide 2' },
] as const

export function PagerScreenshots() {
  return (
