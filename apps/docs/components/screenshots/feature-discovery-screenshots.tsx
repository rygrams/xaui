...
const screenshots = [
  { src: '/screenshots/feature-discovery-1.jpg', alt: 'FeatureDiscovery preview with spotlight overlay' },
  { src: '/screenshots/feature-discovery-2.jpg', alt: 'FeatureDiscovery preview light mode' },
] as const

export function FeatureDiscoveryScreenshots() {
  return (
