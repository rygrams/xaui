...
const screenshots = [
  { src: '/screenshots/fab-menu-1.jpg', alt: 'FabMenu preview light mode' },
  { src: '/screenshots/fab-menu-2.jpg', alt: 'FabMenu preview dark mode' },
] as const

export function FabMenuScreenshots() {
  return (
