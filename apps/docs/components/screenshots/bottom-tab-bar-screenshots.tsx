...
const screenshots = [
  { src: '/screenshots/bottom-tab-bar-1.jpg', alt: 'Bottom Tab Bar preview light mode' },
  { src: '/screenshots/bottom-tab-bar-2.jpg', alt: 'Bottom Tab Bar preview dark mode' },
] as const

export function BottomTabBarScreenshots() {
  return (
