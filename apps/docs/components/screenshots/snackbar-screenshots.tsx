...
const screenshots = [
  {
    src: '/screenshots/snackbar-1.jpg',
    alt: 'Snackbar preview dark mode - variants, multi-line and stack position',
  },
  {
    src: '/screenshots/snackbar-2.jpg',
    alt: 'Snackbar preview light mode - variants, theme and timing',
  },
] as const
