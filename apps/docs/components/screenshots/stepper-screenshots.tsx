...
const screenshots = [
  { src: '/screenshots/stepper-1.jpg', alt: 'Stepper preview light mode' },
  { src: '/screenshots/stepper-2.jpg', alt: 'Stepper preview dark mode' },
] as const

export function StepperScreenshots() {
  return (
