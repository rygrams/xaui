...
const screenshots = [
  { src: '/screenshots/progress-1.jpg', alt: 'Progress preview light mode' },
  { src: '/screenshots/progress-2.jpg', alt: 'Progress preview dark mode' },
] as const

export function ProgressScreenshots() {
  return (
