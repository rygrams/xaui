...
const screenshots = [
  { src: '/screenshots/textarea-1.jpg', alt: 'TextArea preview light mode - theme colors' },
  { src: '/screenshots/textarea-2.jpg', alt: 'TextArea preview dark mode - theme colors' },
] as const

export function TextAreaScreenshots() {
  return (
