...
const screenshots = [
  { src: '/screenshots/number-input-1.jpg', alt: 'NumberInput preview light mode - basic, min/max, currency' },
  { src: '/screenshots/number-input-2.jpg', alt: 'NumberInput preview dark mode - basic, min/max, currency' },
] as const

export function NumberInputScreenshots() {
  return (
