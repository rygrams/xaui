...
const screenshots = [
  { src: '/screenshots/checkbox-1.jpg', alt: 'Checkbox preview dark mode - page 1' },
  { src: '/screenshots/checkbox-2.jpg', alt: 'Checkbox preview dark mode - page 2' },
  { src: '/screenshots/checkbox-3.jpg', alt: 'Checkbox preview light mode' },
] as const

export function CheckboxScreenshots() {
  return (
