...
const screenshots = [
  {
    src: '/screenshots/input-trigger-1.jpg',
    alt: 'InputTrigger preview light mode - variants and sizes',
  },
  {
    src: '/screenshots/input-trigger-2.jpg',
    alt: 'InputTrigger preview dark mode - variants and sizes',
  },
] as const
