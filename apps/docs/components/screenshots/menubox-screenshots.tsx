...
const screenshots = [
  { src: '/screenshots/menubox-1.jpg', alt: 'MenuBox preview light mode' },
  { src: '/screenshots/menubox-2.jpg', alt: 'MenuBox preview dark mode' },
] as const

export function MenuBoxScreenshots() {
  return (
