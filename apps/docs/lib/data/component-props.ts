    ...
    props: [
      {
        ...
        type: 'ReactNode',
        defaultValue: '-',
        description: 'Child elements rendered inside the container',
      },
      {
        name: 'width',
        type: 'number | `${number}%`',
        defaultValue: '-',
        description: 'Width in density-independent pixels or percentage',
      },
      {
        name: 'height',
        type: 'number | `${number}%`',
        defaultValue: '-',
        description: 'Height in density-independent pixels or percentage',
      },
      {
        name: 'minWidth',
        type: 'number',
      ...
      },
      {
        ...
        type: 'number',
        defaultValue: '-',
        description: 'Flex grow/shrink value',
      },
      {
        name: 'padding',
        type: 'EdgeInsets',
      ...
      },
      {
        ...
        type: 'EdgeInsets',
        defaultValue: '-',
        description: 'Outer spacing — same shape as padding',
      },
      {
        name: 'alignment',
        type: 'Alignment',
        defaultValue: '-',
        description:
          '"center" | "topLeft" | "topRight" | "bottomLeft" | "bottomRight" | "centerLeft" | "centerRight" | "topCenter" | "bottomCenter" | { x, y }',
      },
      {
        name: 'color',
        type: 'string',
      ...
      },
      {
        ...
        type: 'Border',
        defaultValue: '-',
        description: 'Border — { color, width, style }',
      },
      {
        name: 'borderRadius',
        type: 'BorderRadius',
      ...
      },
      {
        ...
        defaultValue: '-',
        description:
          'Drop shadow — { color, offset: { x, y }, blur, opacity, elevation }',
      },
      {
        name: 'clip',
        type: 'boolean',
      ...
      },
      {
        ...
        defaultValue: '-',
        description:
          'Transforms — { rotate, scale, scaleX, scaleY, translateX, translateY, skewX, skewY }',
      },
      {
        name: 'opacity',
        type: 'number',
      ...
      },
      {
        ...
        type: '() => void',
        defaultValue: '-',
        description: 'Tap handler — makes container interactive',
      },
      {
        name: 'onLongPress',
        type: '() => void',
      ...
      },
      {
        ...
        type: '() => void',
        defaultValue: '-',
        description: 'Fired on pointer/touch down',
      },
      {
        name: 'onPressOut',
        type: '() => void',
        defaultValue: '-',
        description: 'Fired on pointer/touch up',
      },
      {
        name: 'disabled',
        type: 'boolean',
        defaultValue: 'false',
        description: 'Suppress all press handlers',
      },
      {
        name: 'accessibilityLabel',
        type: 'string',
      ...
      },
      {
        ...
        type: 'StyleProp<ViewStyle>',
        defaultValue: '-',
        description: 'Raw React Native style override',
      },
    ],
    examples: [
      {
        title: 'Basic colored box',
        code: `import { Container } from '@xaui/native/container'
