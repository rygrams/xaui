...
export function NumberInputExample() {
  ...
  list: {
    props: [
      ...
      { name: 'showDivider', type: 'boolean', defaultValue: 'true', description: 'Show dividers between items' },
      { name: 'isPressable', type: 'boolean', defaultValue: 'false', description: 'Make items pressable' },
      { name: 'themeColor', type: 'ThemeColor', defaultValue: '"primary"', description: 'Color theme' },
    ...
    subComponents: [
      {
        ...
        props: [
          { name: 'value', type: 'string', defaultValue: '-', description: 'Item value' },
          { name: 'label', type: 'ReactNode', defaultValue: '-', description: 'Item label' },
          { name: 'startContent', type: 'ReactNode', defaultValue: '-', description: 'Element at start of item' },
          { name: 'isDisabled', type: 'boolean', defaultValue: 'false', description: 'Disable this item' },
        ],
      },
