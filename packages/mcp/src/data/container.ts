export const containerDocs = {
  ...
  packages: {
    ...
    hybrid: {
      package: '@xaui/hybrid',
      import: "import { Container } from '@xaui/hybrid/view'",
  ...
  props: [
    ...
    },
    {
      ...
      default: '-',
      description:
        'Container width (number for dp, string for percentage — native only)',
    },
    {
      name: 'height',
      type: 'number | `${number}%`',
    ...
    },
    {
      ...
      default: '-',
      description:
        'Child alignment — "center" | "topLeft" | "bottomRight" | ... or { x, y } object',
    },
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Clip children to the container bounds (overflow: hidden)',
    },
    {
      name: 'transform',
      ...
      default: '-',
      description:
        'CSS/RN transforms — { rotate, scale, translateX, translateY, skewX, ... }',
    },
    {
      name: 'opacity',
      type: 'number',
    ...
    },
    {
      ...
      default: '-',
      description:
        'Tap handler — makes container interactive (renders as Pressable in native)',
    },
    {
      name: 'onLongPress',
      type: '() => void',
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'false',
      description: 'Suppress all press handlers when true',
    },
    {
    ...
    { name: 'testID', type: 'string', default: '-', description: 'Test identifier' },
    {
      ...
      default: '-',
      description: 'Escape hatch for raw RN/CSS styles',
    },
    {
      name: 'className',
      type: 'string',
      default: '-',
      description: 'Tailwind class names (hybrid only)',
    },
  ],
  examples: [
    {
