export const alertStyles = {
  ...
  iconWrapper: 'size-7.5 rounded-full flex items-center justify-center shrink-0',
  title: 'font-semibold leading-tight m-0',
  description: 'font-normal leading-tight m-0',
  iconText: 'font-semibold',
  closeButton: 'self-start p-1 cursor-pointer bg-transparent border-0 rounded flex',
  extraContent: 'mt-1',
} as const
