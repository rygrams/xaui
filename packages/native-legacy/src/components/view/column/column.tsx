...
/**
 * @deprecated Use `Column` from `@xaui/native/view`. This tree is frozen and receives
 * fixes only.
 *
 * The v1 axis contributes **one declaration**, `flexDirection: 'column'`, and nothing else.
 ...
 *
 * `reversed` is gone: `column` already flips in RTL, which is the case that matters, and a
 * genuine reversal is `style={{ flexDirection: 'column-reverse' }}`.
 */
