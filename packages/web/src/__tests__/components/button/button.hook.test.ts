...
describe('useButtonStyles', () => {
  it('returns correct size styles for md size', () => {
    ...
    expect(result.current.sizeStyles.minHeight).toBe('40px')
    expect(result.current.sizeStyles.fontSize).toBe('16px')
  })
  ...
  it('returns correct size styles for lg size', () => {
    ...
    expect(result.current.sizeStyles.minHeight).toBe('48px')
    expect(result.current.sizeStyles.fontSize).toBe('18px')
  })
  ...
  it('returns correct radius styles', () => {
    ...
    expect(result.current.radiusStyles.borderRadius).toBe('12px')
  })
