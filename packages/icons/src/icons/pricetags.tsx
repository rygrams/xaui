...
export const PricetagsIcon: React.FC<IconProps> = ({
  variant = 'baseline',
  size = 24,
  color = 'default',
  isAnimated = false,
  ...
  const renderBaseline = () => (
    <>
      ...
      <AnimatedPath
        fill={resolvedColor}
        d="M352 144a32 32 0 1 1 32-32a32 32 0 0 1-32 32"
        {...animatedProps}
      />
      <AnimatedPath
        fill="none"
  ...
  const renderFilled = () => (
    <>
      <AnimatedPath
        fill={resolvedColor}
        d="M448 183.8v-123A44.66 44.66 0 0 0 403.29 16H280.36a30.62 30.62 0 0 0-21.51 8.89L13.09 270.58a44.86 44.86 0 0 0 0 63.34l117 117a44.84 44.84 0 0 0 63.33 0l245.69-245.61A30.6 30.6 0 0 0 448 183.8M352 144a32 32 0 1 1 32-32a32 32 0 0 1-32 32"
        {...animatedProps}
      />
      <AnimatedPath
        fill={resolvedColor}
