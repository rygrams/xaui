...
export const ChevronForwardCircleIcon: React.FC<IconProps> = ({
  variant = 'baseline',
  size = 24,
  color = 'default',
  isAnimated = false,
  ...
  const renderSquareFilled = () => (
    <>
      <AnimatedPath
        fill={resolvedColor}
        d="M256 48C141.13 48 48 141.13 48 256s93.13 208 208 208s208-93.13 208-208S370.87 48 256 48m-40 326.63L193.37 352l96-96l-96-96L216 137.37L334.63 256Z"
        {...animatedProps}
      />
    </>
  )
