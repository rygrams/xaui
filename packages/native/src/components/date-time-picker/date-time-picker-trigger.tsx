...
import type { DateTimePickerTriggerProps } from './date-time-picker.type'
 ...
 * treatment are the ones already written. It publishes the indicator's size and colour
 * through `IconContext`.
 */
export const DateTimePickerTrigger = forwardRef<View, DateTimePickerTriggerProps>(
...
DateTimePickerTrigger.displayName = 'XAUI.DateTimePicker.Trigger'
