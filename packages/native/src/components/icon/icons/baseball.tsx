  ...
  const renderOutlined = () => (
    <>
      ...
      <AnimatedPath
        ...
        strokeLinejoin="round"
        strokeWidth={32}
        d="M432.94 255.05a192 192 0 0 1-176.31-180.7M108.54 294.31l17.59-60.57m29.92 83.45l36.4-51.5m2.36 90.26l51.5-36.4m-28.62 83.91l60.57-17.59M255 433.61A192 192 0 0 0 74.29 256.69"
        {...animatedProps}
      />
    </>
  )
